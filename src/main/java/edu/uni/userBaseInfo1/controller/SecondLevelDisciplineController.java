...
public class SecondLevelDisciplineController {
    ...
    @ApiOperation( value = "以一个id获取一条二级学科记录详情",notes = "未测试" )
     ...
     */
    @ApiOperation( value = "获取所有二级学科记录的内容",notes = "未测试" )
     ...
     * @apiNote: 新增二级学科信息
     */
    @ApiOperation(value="新增二级学科信息", notes="未测试")
     ...
     * @apiNote: 删除二级学科
     */
    @ApiOperation(value="删除二级学科", notes="未测试")
     ...
     * @apiNote: 更新二级学科详情
     */
    @ApiOperation(value="更新二级学科详情", notes="未测试")
    @ApiImplicitParam(name = "SecondLevelDiscipline", value = "二级学科详情实体", required = true, dataType = "SecondLevelDiscipline")
