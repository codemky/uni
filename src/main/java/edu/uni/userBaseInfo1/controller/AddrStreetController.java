...
public class AddrStreetController {
    ...
    static class CacheNameHelper{
        // ub1_e_AddrStreet_{街道记录id}
        public static final String Receive_CacheNamePrefix = "ub1_e_AddrStreet_";
        // ub1_e_AddrStreets_listAll
        public static final String ListAll_CacheName = "ub1_e_AddrStreets_listAll";
    }
    ...
    @ApiImplicitParam(name = "id", value = "AddrStreet表的一个id", required = false, dataType = "Integer" , paramType = "path")
    @ResponseBody
    ...
    @ApiImplicitParam(name = "id", value = "街道的id", required = true, dataType = "Integer", paramType = "path")
