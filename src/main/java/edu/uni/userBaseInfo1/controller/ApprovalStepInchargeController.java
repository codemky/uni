...
/**
 * @Author laizhouhao
 * @Description 关于某种审批的某步骤详情的角色信息模块的Controller层（Http URL请求）的具体实现方法
 * @Date 16:15 2019/4/29
 **/
//填写description内容可以在测试模块显示相应的文字和模块
@Api(description = "某种审批的某步骤详情的角色信息模块")
...
public class ApprovalStepInchargeController {
    ...
    static class CacheNameHelper{
        // ub1_a_approvalStepIncharge_{某种审批的某步骤详情的角色记录id}
    ...
    @ApiOperation( value = "以一个id获取一条某种审批的某步骤详情的角色记录详情",notes = "2019年5月6日 18:07:20 已通过测试" )
     ...
     * @apiNote: 查询某种审批的某步骤详情的角色的所有记录
     */
    @ApiOperation( value = "获取所有某种审批的某步骤详情的角色记录的内容",notes = "2019年5月6日 18:07:47 已通过测试" )
     ...
     */
    @ApiOperation(value="新增某种审批的某步骤详情的角色信息记录", notes="未测试")
    @ApiImplicitParam(name = "approvalStepIncharge", value = "某种审批的某步骤详情的角色详情实体", required = true, dataType = "ApprovalStepIncharge")
    ...
    public Result create(@RequestBody(required = false)ApprovalStepIncharge approvalStepIncharge){
        ...
        if(approvalStepIncharge!=null){
            ...
            boolean main_sucess = approvalMainService.update(approvalMain);

            boolean success = approvalStepInchargeService.insert(approvalStepIncharge);
            if(success || main_sucess){
     ...
     * @param id
     * @return 删除某种审批的某步骤详情的角色信息结果
     */
    @ApiOperation(value="逻辑删除删除某种审批的某步骤详情的角色信息", notes="未测试")
    @ApiImplicitParam(name = "id", value = "某种审批的某步骤详情的角色id", required = true, dataType = "Long", paramType = "path")
     ...
     * @return 更新操作结果
     */
    @ApiOperation(value="更新某种审批的某步骤详情的角色信息", notes="2019年5月6日 18:08:42 已通过测试")
    @ApiImplicitParam(name = "approvalStepIncharge", value = "某种审批的某步骤详情的角色信息详情实体", required = true, dataType = "ApprovalStepIncharge")
