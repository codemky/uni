...
/**
 * @Author laizhouhao
 * @Description 关于每一种申请的每一个审批步骤的角色信息模块的Controller层（Http URL请求）的具体实现方法
 * @Date 16:15 2019/4/29
 **/
//填写description内容可以在测试模块显示相应的文字和模块
@Api(description = "每一种申请的每一个审批步骤的角色信息模块")
...
public class ApprovalStepInchargeController {
    ...
    static class CacheNameHelper{
        // ub1_a_approvalStepIncharge_{每一种申请的每一个审批步骤的角色记录id}
     ...
     * @param id
     * @return response
     * @apiNote: 获取每一种申请的每一个审批步骤的角色信息详细
     */
