...
import edu.uni.userBaseInfo1.alibaba.easyexcel.test.listen.AfterWriteHandlerImpl;
import edu.uni.userBaseInfo1.alibaba.easyexcel.test.model.WriteModel;
...
import static edu.uni.userBaseInfo1.alibaba.easyexcel.test.util.DataUtil.*;
...
public class WriteTest {
    ...
    public void writeV2007() throws IOException {
        ...
        writer.write((List<? extends BaseRowModel>) createTestListJavaMode(), sheet2);
        //需要合并单元格
        ...
        writer.write((List<? extends BaseRowModel>) createTestListJavaMode(), sheet3, table2);
